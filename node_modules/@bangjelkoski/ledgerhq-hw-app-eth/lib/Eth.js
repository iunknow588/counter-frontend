...
exports.Eth = exports.ledgerService = void 0;
...
class Eth {
    ...
    async signTransaction(path, rawTxHex, resolution) {
        ...
        if (resolution === undefined) {
            ...
            resolution = await ledger_1.default
        ...
        if (resolution) {
            for (const domainDescriptor of resolution.domains) {
                await (0, Domains_1.domainResolutionFlow)(this, domainDescriptor).catch(e => {
        ...
        const chainId = new bignumber_js_1.BigNumber(parsedTransaction.chainId);
        const paths = (0, utils_1.splitPath)(path);
        ...
        const payloadChunks = (0, utils_1.safeChunkTransaction)(rawTx, derivationPathBuff, parsedTransaction.type);
        let response;
    ...
    async clearSignTransaction(path, rawTxHex, resolutionConfig, throwOnError = false) {
        const resolution = await ledger_1.default
