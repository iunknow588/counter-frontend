...
export declare function getSuborgs(request: GetSuborgsRequest): Promise<GetSuborgsResponse | undefined>;
export declare function getVerifiedSuborgs(request: GetSuborgsRequest): Promise<GetSuborgsResponse | undefined>;
export declare function createSuborg(request: CreateSuborgRequest): Promise<CreateSuborgResponse | undefined>;
export declare function getOrCreateSuborg(request: GetOrCreateSuborgRequest): Promise<GetOrCreateSuborgResponse | undefined>;
