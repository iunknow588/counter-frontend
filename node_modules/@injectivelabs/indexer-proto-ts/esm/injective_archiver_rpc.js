...
export const AccountStatsRequest = {
    encode(message, writer = _m0.Writer.create()) {
        if (message.account !== "") {
            writer.uint32(10).string(message.account);
        }
    ...
    create(base) {
        return AccountStatsRequest.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseAccountStatsRequest();
        message.account = object.account ?? "";
...
export const AccountStatsResponse = {
    encode(message, writer = _m0.Writer.create()) {
        if (message.account !== "") {
            writer.uint32(10).string(message.account);
        }
    ...
    create(base) {
        return AccountStatsResponse.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseAccountStatsResponse();
        message.account = object.account ?? "";
...
export class InjectiveArchiverRPCClientImpl {
    ...
    AccountStats(request, metadata) {
        return this.rpc.unary(InjectiveArchiverRPCAccountStatsDesc, AccountStatsRequest.fromPartial(request), metadata);
    }
...
export const InjectiveArchiverRPCAccountStatsDesc = {
    ...
    requestType: {
        serializeBinary() {
            return AccountStatsRequest.encode(this).finish();
        },
    },
    responseType: {
        deserializeBinary(data) {
            const value = AccountStatsResponse.decode(data);
            return {
                ...value,
                toObject() {
                    return value;
