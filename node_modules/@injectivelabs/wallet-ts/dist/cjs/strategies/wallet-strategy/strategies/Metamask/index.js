...
class Metamask extends Base_js_1.default {
    constructor(args) {
        super(args);
    }
    getWalletDeviceType() {
    ...
    getEthereum() {
        return __awaiter(this, void 0, void 0, function* () {
            const provider = yield (0, utils_js_1.getMetamaskProvider)();
            if (!provider) {
                throw new exceptions_1.MetamaskException(new Error('Please install the Metamask wallet extension.'), {
                    code: exceptions_1.UnspecifiedErrorCode,
