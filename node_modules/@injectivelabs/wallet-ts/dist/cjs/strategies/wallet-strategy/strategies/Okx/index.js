...
class OkxWallet extends Base_js_1.default {
    constructor(args) {
        super(args);
    }
    getWalletDeviceType() {
    ...
    disconnect() {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.listeners[enums_js_1.WalletEventListener.AccountChange]) {
                ...
                ethereum.removeListener('accountsChanged', this.listeners[enums_js_1.WalletEventListener.AccountChange]);
            }
            if (this.listeners[enums_js_1.WalletEventListener.ChainIdChange]) {
                const ethereum = yield this.getEthereum();
                ethereum.removeListener('chainChanged', this.listeners[enums_js_1.WalletEventListener.ChainIdChange]);
            }
            this.listeners = {};
        });
    }
    getAddresses() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                throw new exceptions_1.OkxWalletException(new Error(e.message), {
    ...
    getEthereum() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!provider) {
                throw new exceptions_1.OkxWalletException(new Error('Please install the OkxWallet wallet extension.'), {
                    code: exceptions_1.UnspecifiedErrorCode,
