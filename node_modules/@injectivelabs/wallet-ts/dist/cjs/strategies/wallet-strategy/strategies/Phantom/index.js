...
class Phantom extends Base_js_1.default {
    constructor(args) {
        super(args);
    }
    getWalletDeviceType() {
    ...
    getEthereum() {
        return __awaiter(this, void 0, void 0, function* () {
            const provider = yield (0, utils_js_1.getPhantomProvider)();
            if (!provider) {
                throw new exceptions_1.MetamaskException(new Error('Please install the Phantom wallet extension.'), {
                    code: exceptions_1.UnspecifiedErrorCode,
