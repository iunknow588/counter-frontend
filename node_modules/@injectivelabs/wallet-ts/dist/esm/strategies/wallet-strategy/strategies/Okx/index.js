...
import { ErrorType, WalletException, OkxWalletException, UnspecifiedErrorCode, TransactionException, } from '@injectivelabs/exceptions';
...
export default class OkxWallet extends BaseConcreteStrategy {
    constructor(args) {
        super(args);
    }
    ...
    async getAddresses() {
        ...
        try {
            ...
            throw new OkxWalletException(new Error(e.message), {
    ...
    async getEthereum() {
        const provider = await getOkxWalletProvider();
        if (!provider) {
            throw new OkxWalletException(new Error('Please install the OkxWallet wallet extension.'), {
                code: UnspecifiedErrorCode,
