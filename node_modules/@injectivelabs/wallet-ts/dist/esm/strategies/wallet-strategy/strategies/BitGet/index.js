...
import { ErrorType, WalletException, BitGetException, UnspecifiedErrorCode, TransactionException, } from '@injectivelabs/exceptions';
...
import { getBitGetProvider } from './utils.js';
export default class BitGet extends BaseConcreteStrategy {
    constructor(args) {
        super(args);
    }
    ...
    async getAddresses() {
        ...
        try {
            ...
            throw new BitGetException(new Error(e.message), {
    ...
    async getEthereum() {
        ...
        if (!provider) {
            throw new BitGetException(new Error('Please install the BitGet wallet extension.'), {
                code: UnspecifiedErrorCode,
