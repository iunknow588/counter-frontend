...
import { sanitizeTypedData, TypedDataUtilsHashStruct, SignTypedDataVersionV4, TypedDataUtilsSanitizeData, } from '@injectivelabs/sdk-ts';
/**
...
export const transformTypedData = (data, metamask_v4_compat = true) => {
    ...
    const { types, primaryType, domain, message } = TypedDataUtilsSanitizeData(data);
