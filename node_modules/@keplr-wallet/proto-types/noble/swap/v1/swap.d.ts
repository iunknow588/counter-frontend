...
export declare const Swap: {
    ...
    fromPartial<I extends {
        ...
        in?: ({
            ...
            denom?: string | undefined;
            amount?: string | undefined;
        } & Record<Exclude<keyof I["in"], keyof Coin>, never>) | undefined;
        out?: ({
            denom?: string | undefined;
            amount?: string | undefined;
        } & {
            denom?: string | undefined;
            amount?: string | undefined;
        } & Record<Exclude<keyof I["out"], keyof Coin>, never>) | undefined;
        fees?: ({
            denom?: string | undefined;
            amount?: string | undefined;
        }[] & ({
    ...
    } & Record<Exclude<keyof I, keyof Swap>, never>>(object: I): Swap;
};
