...
export declare const MsgClaimYield: {
    ...
    fromPartial<I extends {
        ...
        signer?: string | undefined;
    } & Record<Exclude<keyof I, "signer">, never>>(object: I): MsgClaimYield;
};
export declare const MsgClaimYieldResponse: {
    encode(_: MsgClaimYieldResponse, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): MsgClaimYieldResponse;
    fromJSON(_: any): MsgClaimYieldResponse;
    toJSON(_: MsgClaimYieldResponse): unknown;
    fromPartial<I extends {} & {} & Record<Exclude<keyof I, never>, never>>(_: I): MsgClaimYieldResponse;
};
export declare const MsgSetPausedState: {
    ...
    fromPartial<I extends {
        ...
        signer?: string | undefined;
        paused?: boolean | undefined;
    } & Record<Exclude<keyof I, keyof MsgSetPausedState>, never>>(object: I): MsgSetPausedState;
};
export declare const MsgSetPausedStateResponse: {
    encode(_: MsgSetPausedStateResponse, writer?: _m0.Writer): _m0.Writer;
    decode(input: _m0.Reader | Uint8Array, length?: number): MsgSetPausedStateResponse;
    fromJSON(_: any): MsgSetPausedStateResponse;
    toJSON(_: MsgSetPausedStateResponse): unknown;
    fromPartial<I extends {} & {} & Record<Exclude<keyof I, never>, never>>(_: I): MsgSetPausedStateResponse;
};
