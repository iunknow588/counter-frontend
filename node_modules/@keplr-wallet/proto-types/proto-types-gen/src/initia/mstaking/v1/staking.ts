...
export const protobufPackage = "initia.mstaking.v1";
...
export const Validator = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 12:
          ...
          break;
        case 13:
          message.unbondingOnHoldRefCount = longToString(
  ...
  fromJSON(object: any): Validator {
    return {
      ...
      tokens: Array.isArray(object?.tokens)
        ...
        : [],
      delegatorShares: Array.isArray(object?.delegatorShares)
      ...
      commission: isSet(object.commission)
        ...
        : undefined,
      votingPowers: Array.isArray(object?.votingPowers)
        ? object.votingPowers.map((e: any) => Coin.fromJSON(e))
        : [],
  ...
  toJSON(message: Validator): unknown {
    ...
    if (message.delegatorShares) {
      obj.delegatorShares = message.delegatorShares.map((e) =>
  ...
  fromPartial<I extends Exact<DeepPartial<Validator>, I>>(
    ...
    message.delegatorShares =
      object.delegatorShares?.map((e) => DecCoin.fromPartial(e)) || [];
    message.description =
    ...
    message.votingPowers =
      object.votingPowers?.map((e) => Coin.fromPartial(e)) || [];
  ...
  fromJSON(object: any): Delegation {
    return {
      ...
      shares: Array.isArray(object?.shares)
        ? object.shares.map((e: any) => DecCoin.fromJSON(e))
        : [],
    };
  },
...
export const UnbondingDelegationEntry = {
  ...
  fromJSON(object: any): UnbondingDelegationEntry {
    return {
      ...
      completionTime: isSet(object.completionTime)
        ...
        : undefined,
      initialBalance: Array.isArray(object?.initialBalance)
  ...
  toJSON(message: UnbondingDelegationEntry): unknown {
    ...
    if (message.initialBalance) {
      obj.initialBalance = message.initialBalance.map((e) =>
        e ? Coin.toJSON(e) : undefined
      );
    } else {
      obj.initialBalance = [];
  ...
  fromPartial<I extends Exact<DeepPartial<UnbondingDelegationEntry>, I>>(
    ...
    message.initialBalance =
      object.initialBalance?.map((e) => Coin.fromPartial(e)) || [];
...
export const RedelegationEntry = {
  ...
  fromJSON(object: any): RedelegationEntry {
    return {
      ...
      initialBalance: Array.isArray(object?.initialBalance)
        ? object.initialBalance.map((e: any) => Coin.fromJSON(e))
        : [],
      sharesDst: Array.isArray(object?.sharesDst)
        ? object.sharesDst.map((e: any) => DecCoin.fromJSON(e))
        : [],
      unbondingId: isSet(object.unbondingId) ? String(object.unbondingId) : "0",
      unbondingOnHoldRefCount: isSet(object.unbondingOnHoldRefCount)
        ? String(object.unbondingOnHoldRefCount)
  ...
  toJSON(message: RedelegationEntry): unknown {
    ...
    if (message.sharesDst) {
      obj.sharesDst = message.sharesDst.map((e) =>
        e ? DecCoin.toJSON(e) : undefined
      );
    } else {
      obj.sharesDst = [];
  ...
  fromPartial<I extends Exact<DeepPartial<RedelegationEntry>, I>>(
    ...
    message.initialBalance =
      object.initialBalance?.map((e) => Coin.fromPartial(e)) || [];
    message.sharesDst =
      object.sharesDst?.map((e) => DecCoin.fromPartial(e)) || [];
    message.unbondingId = object.unbondingId ?? "0";
    message.unbondingOnHoldRefCount = object.unbondingOnHoldRefCount ?? "0";
    return message;
  },
...
export const Params = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 5:
          ...
          break;
        case 6:
          message.minVotingPower = longToString(reader.uint64() as Long);
          break;
        case 7:
  ...
  fromJSON(object: any): Params {
    return {
      ...
      historicalEntries: isSet(object.historicalEntries)
        ...
        : 0,
      bondDenoms: Array.isArray(object?.bondDenoms)
        ? object.bondDenoms.map((e: any) => String(e))
        : [],
  ...
  fromPartial<I extends Exact<DeepPartial<Params>, I>>(object: I): Params {
    ...
    message.minVotingPower = object.minVotingPower ?? "0";
...
export const Pool = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          break;
        case 3:
          message.votingPowerWeights.push(
  ...
  fromJSON(object: any): Pool {
    return {
      notBondedTokens: Array.isArray(object?.notBondedTokens)
        ? object.notBondedTokens.map((e: any) => Coin.fromJSON(e))
        : [],
      bondedTokens: Array.isArray(object?.bondedTokens)
        ? object.bondedTokens.map((e: any) => Coin.fromJSON(e))
        : [],
      votingPowerWeights: Array.isArray(object?.votingPowerWeights)
        ? object.votingPowerWeights.map((e: any) => DecCoin.fromJSON(e))
        : [],
    };
  },
  ...
  toJSON(message: Pool): unknown {
    ...
    if (message.notBondedTokens) {
      obj.notBondedTokens = message.notBondedTokens.map((e) =>
        e ? Coin.toJSON(e) : undefined
      );
    } else {
      obj.notBondedTokens = [];
    ...
    if (message.bondedTokens) {
      obj.bondedTokens = message.bondedTokens.map((e) =>
        e ? Coin.toJSON(e) : undefined
      );
    } else {
      obj.bondedTokens = [];
    ...
    if (message.votingPowerWeights) {
      obj.votingPowerWeights = message.votingPowerWeights.map((e) =>
        e ? DecCoin.toJSON(e) : undefined
      );
    } else {
  ...
  fromPartial<I extends Exact<DeepPartial<Pool>, I>>(object: I): Pool {
    ...
    message.notBondedTokens =
      object.notBondedTokens?.map((e) => Coin.fromPartial(e)) || [];
    message.bondedTokens =
      object.bondedTokens?.map((e) => Coin.fromPartial(e)) || [];
    message.votingPowerWeights =
      object.votingPowerWeights?.map((e) => DecCoin.fromPartial(e)) || [];
    return message;
  },
};
