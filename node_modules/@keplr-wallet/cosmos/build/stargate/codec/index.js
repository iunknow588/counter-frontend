...
const tx_12 = require("@keplr-wallet/proto-types/babylon/epoching/v1/tx");
const tx_13 = require("@keplr-wallet/proto-types/babylon/incentive/tx");
const tx_14 = require("@keplr-wallet/proto-types/babylon/btcstaking/v1/tx");
const tx_15 = require("@keplr-wallet/proto-types/atomone/photon/v1/tx");
...
exports.defaultProtoCodec.registerAny("/babylon.epoching.v1.MsgWrappedDelegate", tx_12.MsgWrappedDelegate);
exports.defaultProtoCodec.registerAny("/babylon.epoching.v1.MsgWrappedUndelegate", tx_12.MsgWrappedUndelegate);
exports.defaultProtoCodec.registerAny("/babylon.epoching.v1.MsgWrappedCancelUnbondingDelegation", tx_12.MsgWrappedCancelUnbondingDelegation);
exports.defaultProtoCodec.registerAny("/babylon.epoching.v1.MsgWrappedBeginRedelegate", tx_12.MsgWrappedBeginRedelegate);
exports.defaultProtoCodec.registerAny("/babylon.incentive.MsgWithdrawReward", tx_13.MsgWithdrawReward);
exports.defaultProtoCodec.registerAny("/babylon.btcstaking.v1.MsgCreateBTCDelegation", tx_14.MsgCreateBTCDelegation);
exports.defaultProtoCodec.registerAny("/atomone.photon.v1.MsgMintPhoton", tx_15.MsgMintPhoton);
