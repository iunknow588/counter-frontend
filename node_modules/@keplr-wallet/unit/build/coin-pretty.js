...
class CoinPretty {
    static makeCoinDenomPretty(coinDenom) {
        const isHexString = /^(?:0[xX][0-9a-fA-F]+|[0-9][0-9a-fA-F]*)$/.test(coinDenom);
        if (isHexString) {
    ...
    toString() {
        ...
        if (!this._options.hideIBCMetadata) {
            if ("originCurrency" in this.currency &&
                this.currency.originCurrency &&
                this.currency.originCurrency.coinDenom.length >
                    this._options.maxCoinDenomLength) {
                denom = denom.replace(this.currency.originCurrency.coinDenom, `${this.currency.originCurrency.coinDenom.slice(0, this._options.maxCoinDenomLength)}...`);
            }
        }
        else {
