 ...
 */
export function registerCryptoCurrency(currency) {
    var _a;
 ...
 */
export function listCryptoCurrencies(withDevCrypto = false, withTerminated = false) {
 ...
 * @param {*} keyword
 */
export const findCryptoCurrencyByKeyword = (keyword, tests = ["keywords", "name", "id", "ticker", "manager"]) => {
...
export const findCryptoCurrencyByManagerAppName = (managerAppName) => {
 ...
 * @param {*} id
 */
export const hasCryptoCurrencyId = (id) => id in cryptocurrenciesById;
