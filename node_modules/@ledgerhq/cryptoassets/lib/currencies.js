...
const makeTestnetUnit = u => (Object.assign(Object.assign({}, u), { code: `𝚝${u.code}` }));
const bitcoinUnits = [
    {
        name: "bitcoin",
        code: "BTC",
...
exports.cryptocurrenciesById = {
    ...
    casper: {
        name: "Casper",
        ticker: "CSPR",
        coinType: types_cryptoassets_1.CoinType.CSPR,
        color: "#000000",
        family: "casper",
        id: "casper",
...
for (const cryptoCurrency of Object.values(exports.cryptocurrenciesById)) {
...
function registerCryptoCurrency(currency) {
    ...
    if (!currency.isTestnetFor) {
        ...
        const curencyHasTickerinKeywords = Boolean((_a = currency === null || currency === void 0 ? void 0 : currency.keywords) === null || _a === void 0 ? void 0 : _a.includes(currency.ticker));
...
const testsMap = {
    keywords: s => findCryptoCurrency(c => { var _a; return Boolean((_a = c === null || c === void 0 ? void 0 : c.keywords) === null || _a === void 0 ? void 0 : _a.map(k => k.replace(/ /, "").toLowerCase()).includes(s)); }),
    ...
    manager: s => (0, exports.findCryptoCurrencyByManagerAppName)(s),
};
/**
 *
 * @param {*} keyword
 */
const findCryptoCurrencyByKeyword = (keyword, tests = ["keywords", "name", "id", "ticker", "manager"]) => {
    const search = keyword.replace(/ /, "").toLowerCase();
    const conditions = tests.map(t => testsMap[t]);
...
const findCryptoCurrencyByManagerAppName = (managerAppName) => {
    const search = managerAppName.replace(/ /, "").toLowerCase();
    return (findCryptoCurrency(c => c.managerAppName === managerAppName) ||
        findCryptoCurrency(c => Boolean(c.managerAppName && c.managerAppName.replace(/ /, "").toLowerCase() === search)));
};
 ...
 * @param {*} id
 */
const hasCryptoCurrencyId = (id) => id in exports.cryptocurrenciesById;
