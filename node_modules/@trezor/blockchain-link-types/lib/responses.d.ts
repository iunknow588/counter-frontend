...
import type { AccountBalanceHistory, AccountInfo, ChannelMessage, FiatRatesBySymbol, ServerInfo, Transaction, Utxo } from './common';
...
export type Response = ChannelMessage<WithoutPayload> | ChannelMessage<{
    type: typeof RESPONSES.DISCONNECTED;
    payload: boolean;
}> | ChannelMessage<Error> | ChannelMessage<Connect> | ChannelMessage<GetInfo> | ChannelMessage<GetBlockHash> | ChannelMessage<GetBlock> | ChannelMessage<GetAccountInfo> | ChannelMessage<GetAccountUtxo> | ChannelMessage<GetTransaction> | ChannelMessage<GetTransactionHex> | ChannelMessage<GetAccountBalanceHistory> | ChannelMessage<GetCurrentFiatRates> | ChannelMessage<GetFiatRatesForTimestamps> | ChannelMessage<GetFiatRatesTickersList> | ChannelMessage<EstimateFee> | ChannelMessage<RpcCall> | ChannelMessage<Subscribe> | ChannelMessage<Unsubscribe> | ChannelMessage<Notification> | ChannelMessage<PushTransaction>;
export {};
